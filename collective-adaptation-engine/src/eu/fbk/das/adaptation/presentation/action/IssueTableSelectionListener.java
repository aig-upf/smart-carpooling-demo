...
public class IssueTableSelectionListener implements ListSelectionListener {

    private JTable table;
    private EnsembleManager ensembleManager;
    private CAWindow window;

    public IssueTableSelectionListener(JTable IssueResolutionsList, EnsembleManager ens, CAWindow window) {
