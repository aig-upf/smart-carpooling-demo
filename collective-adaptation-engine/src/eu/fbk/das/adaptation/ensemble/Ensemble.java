...
/**
 * Main type of an ensemble, defined by a name, a sequence of roles and a list
 * of variables
 * 
 * 
 * <p>
 ...
 *       &lt;sequence>
 *         &lt;sequence>
 *           &lt;element name="role" type="{http://das.fbk.eu/Ensemble}Role" maxOccurs="unbounded"/>
 *         &lt;/sequence>
...
@XmlType(name = "", propOrder = { "role", "variable" })
@XmlRootElement(name = "ensemble", namespace = "http://das.fbk.eu/Ensemble")
public class Ensemble {

	@XmlElement(namespace = "http://das.fbk.eu/Ensemble", required = true)
	...
	@XmlElement(namespace = "http://das.fbk.eu/Ensemble")
